        ...
        <div class="col-12">
            <div class="card">
                ...
                @if ($reg->count() < 1)
                    ...
                    <div class="card-body" id="UpgradeMember">
                        <div class="row mt-4">
                            <div class="col-12 col-lg-8 offset-lg-2  x">
                                <div class="wizard-steps">
                                    <div style="cursor: pointer" data-id="wizard-form-1"
                        ...
                        <form class="wizard-content mt-2" id="upgrade">
                            <div class="wizard-pane" id="wizard-form-1">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-md-8">
                                        <input type="file" name="image" class="image-input-preview"
                                            data-id="gambar-preview">
                                        <img id="gambar-preview" class="img-fluid mt-3" src="" alt=""
                            ...
                            <div class="wizard-pane" id="wizard-form-3" style="display: none">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6 col-md-8">
                                        ...
                                        <button class="btn float-right btn-icon icon-right btn-primary" type="submit">Submit
                ...
                <div class="card-body text-center" id="UpgradeDone">
                    @if ($reg->count() > 0)
                        @if ($reg[0]->deleted_at == null)
                            @if ($reg[0]->status == 1)
                                <h1>Selamat, anda telah terdaftar sebagai member</h1>
                                <i class="fas fa-check text-success mt-4" style="font-size:62px"></i>
                            @else
                                <h1>Mohon tunggu! permintaan anda sedang di proses</h1>
