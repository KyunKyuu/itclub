...
@section('main')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="ml-auto">
                        <a href="#" class="btn btn-primary rounded" data-target="#insertSubmenu" data-toggle="modal"><i
    ...
    <div class="modal fade" id="insertSubmenu" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="insertSubmenuLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="updateSubmenu" data-backdrop="static" tabindex="-1" role="dialog"
        aria-labelledby="updateSubmenuLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header border-bottom pb-4">
