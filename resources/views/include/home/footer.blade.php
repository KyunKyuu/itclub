 <!-- footer -->
      <div class="footer-body p-5">
          <div class="container">
              <div class="row">
                  <div class="col-md-3 judul-1">
                      <h5><b>Tentang</b></h5>
                      <a href="" class="text-decoration-none d-block my-1 mt-2">Prestasi</a>
                      <a href="html/berita.html" class="text-decoration-none d-block my-1">Berita kegiatan</a>
                      <a href="html/tentang.html" class="text-decoration-none d-block my-1">Tentang It Club</a>
                      <a href="" class="text-decoration-none d-block my-1">Divisi</a>
                  </div>
                  <div class="col-md-3 judul-1">
                  ...
                  <div class="col-md-3 judul-1">
                    ...
                    <p class="my-1">itclubsmk5bdg@gmail.com</a>
                  </div>
                  <div class="col-md-3 judul-1">
                    <h5><b>Ikut Kami</b></h5>
