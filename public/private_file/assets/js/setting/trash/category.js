$(document).ready(function() {
    ...
    Table({table:'table', data:data, url:'/api/v1/trash/category/get'})
    ...
    $('#recoveryData').on('click', function (e) {
        ...
        SweetQuestions({
            ...
            subtitle : 'Apakah anda ingin merestore data category ini?',
            buttonConfirm : 'Yes',
            buttonDeny: 'No',
            confirm : 'ajax',
            deny : {
            ...
            ajax : {
                url:'/api/v1/trash/category/recovery',
                data:{
    ...
    $('#deleteData').on('click', function (e) {
        ...
        SweetQuestions({
            ...
            ajax : {
                url:'/api/v1/trash/category/delete',
                data:{
                    value : value_checkbox
                },
                type:'DELETE',
