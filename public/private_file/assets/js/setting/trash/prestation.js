$(document).ready(function() {
    ...
    Table({table:'table', data:data, url:'/api/v1/trash/prestation/get'})
    ...
    $('#recoveryData').on('click', function (e) {
        ...
        SweetQuestions({
            ...
            subtitle : 'Apakah anda ingin merestore data prestation ini?',
            buttonConfirm : 'Yes',
            buttonDeny: 'No',
            confirm : 'ajax',
            deny : {
            ...
            ajax : {
                url:'/api/v1/trash/prestation/recovery',
                data:{
    ...
    $('#deleteData').on('click', function (e) {
        ...
        SweetQuestions({
            title : 'Apakah anda yakin?',
            subtitle : 'Apakah anda ingin menghapus data prestation ini?',
            buttonConfirm : 'Yes',
            buttonDeny: 'No',
            confirm : 'ajax',
            deny : {
            ...
            ajax : {
                url:'/api/v1/trash/prestation/delete',
                data:{
                    value : value_checkbox
                },
                type:'DELETE',
