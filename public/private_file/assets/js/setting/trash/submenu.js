$(document).ready(function() {
    ...
    Table({table:'table', data:data, url:'/api/v1/trash/submenu/get'})
    ...
    $('#recoveryData').on('click', function (e) {
        ...
        SweetQuestions({
            ...
            subtitle : 'Apakah anda ingin merestore data submenu ini?',
            buttonConfirm : 'Yes',
            buttonDeny: 'No',
            confirm : 'ajax',
            deny : {
            ...
            ajax : {
                url:'/api/v1/trash/submenu/recovery',
                data:{
    ...
    $('#deleteData').on('click', function (e) {
        ...
        SweetQuestions({
            ...
            ajax : {
                url:'/api/v1/trash/submenu/delete',
                data:{
                    value : value_checkbox
                },
                type:'DELETE',
