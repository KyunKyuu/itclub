$(document).ready(function() {
    ...
    Table({table:'table', data:data, url:'/api/v1/trash/division/get'})
    ...
    $('#recoveryData').on('click', function (e) {
        ...
        SweetQuestions({
            ...
            subtitle : 'Apakah anda ingin merestore data division ini?',
            buttonConfirm : 'Yes',
            buttonDeny: 'No',
            confirm : 'ajax',
            deny : {
            ...
            ajax : {
                url:'/api/v1/trash/division/recovery',
                data:{
    ...
    $('#deleteData').on('click', function (e) {
        ...
        SweetQuestions({
            title : 'Apakah anda yakin?',
            subtitle : 'Apakah anda ingin menghapus data division ini?',
            buttonConfirm : 'Yes',
            buttonDeny: 'No',
            confirm : 'ajax',
            deny : {
            ...
            ajax : {
                url:'/api/v1/trash/division/delete',
                data:{
                    value : value_checkbox
                },
                type:'DELETE',
